...
namespace ProBuilder2.Examples
{
	public class CameraControls : MonoBehaviour
	{
		...
		void Start()
		{
			distance = Vector3.Distance(transform.parent.parent.parent.position, Vector3.zero);
		}

		void LateUpdate()
		{
			Vector3 eulerRotation = transform.parent.parent.parent.localRotation.eulerAngles;
			eulerRotation.z = 0f;
			...
			transform.parent.parent.parent.localRotation = Quaternion.Euler( eulerRotation );
			transform.parent.parent.parent.position = transform.parent.parent.parent.localRotation * (Vector3.forward * -distance);
