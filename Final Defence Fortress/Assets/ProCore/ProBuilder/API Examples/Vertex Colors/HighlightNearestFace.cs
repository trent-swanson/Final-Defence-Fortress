...
public class HighlightNearestFace : MonoBehaviour
{
	...
	void Start()
	{
		...
		target.transform.parent.parent.parent.position = new Vector3(travel * .5f, 0f, travel * .5f);
		...
		cam.transform.parent.parent.parent.position = new Vector3(25f, 40f, 0f);
		cam.transform.parent.parent.parent.localRotation = Quaternion.Euler( new Vector3(65f, 0f, 0f) );
	}
	...
	void Update()
	{
		...
		transform.parent.parent.parent.position = position;
		...
		Vector3 pbRelativePosition = target.transform.parent.parent.parent.InverseTransformPoint(transform.parent.parent.parent.position);
